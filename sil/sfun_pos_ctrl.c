 ...
 *
 *         void pos_ctrl_lct(single u1[3], single u2[3], single u3[3], single u4, single y1[1], single y2[3])
 *
 *    Simulink version           : 25.2 (R2025b) 28-Jul-2025
 *    C source code generated on : 19-Jul-2026 14:05:19
 *
...
/**
     ...
     def.SFunctionName = 'sfun_pos_ctrl';
     def.OutputFcnSpec = 'void pos_ctrl_lct(single u1[3], single u2[3], single u3[3], single u4, single y1[1], single y2[3])';
     def.HeaderFiles = {'flight_ctrl_lct.h'};
     def.SourceFiles = {'flight_ctrl.c', 'flight_ctrl_lct.c'};
...
#define S_FUNCTION_NAME  sfun_pos_ctrl
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "pos_ctrl_lct", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    pos_ctrl_lct(u1, u2, u3, *u4, y1, y2);
}
