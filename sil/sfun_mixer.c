 ...
 *
 *         void mixer_lct(single u1, single u2[3], single y1[4])
 *
 *    Simulink version           : 25.2 (R2025b) 28-Jul-2025
 *    C source code generated on : 19-Jul-2026 14:05:24
 *
...
/**
     ...
     def.SFunctionName = 'sfun_mixer';
     def.OutputFcnSpec = 'void mixer_lct(single u1, single u2[3], single y1[4])';
...
#define S_FUNCTION_NAME  sfun_mixer
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "mixer_lct", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
