 ...
 *
 *         void att_ctrl_lct(single u1[3], single u2[3], single y1[3])
 *
 *    Simulink version           : 25.2 (R2025b) 28-Jul-2025
 *    C source code generated on : 19-Jul-2026 14:05:21
 *
...
/**
     ...
     def.SFunctionName = 'sfun_att_ctrl';
     def.OutputFcnSpec = 'void att_ctrl_lct(single u1[3], single u2[3], single y1[3])';
...
#define S_FUNCTION_NAME  sfun_att_ctrl
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "att_ctrl_lct", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
